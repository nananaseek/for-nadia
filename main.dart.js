...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var canvas, ctx, t4, t1 = {},
        t2 = document,
        t3 = type$.HtmlElement._as(t2.querySelector("body")).style;
      t3.backgroundColor = "black";
      canvas = type$.CanvasElement._as(t2.querySelector("#canvas"));
      B.CanvasElement_methods.set$width(canvas, window.innerWidth);
      B.CanvasElement_methods.set$height(canvas, window.innerHeight);
      ctx = type$.CanvasRenderingContext2D._as(B.CanvasElement_methods.getContext$1(canvas, "2d"));
      t2 = canvas.width;
      t2.toString;
      t3 = canvas.height;
      t3.toString;
      t4 = Math.min(t2, t3);
      t1.animating = false;
      t4 = new A.main_drawHeart(ctx, canvas, t2 / 2, t3 / 2, t4 / 4);
      t4.call$1(1);
      t3 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(canvas, "click", t3._eval$1("~(1)?")._as(new A.main_closure(t1, t4)), false, t3._precomputed1);
    },
    main_drawHeart: function main_drawHeart(t0, t1, t2, t3, t4) {
      var _ = this;
      _.ctx = t0;
      _.canvas = t1;
      _.centerX = t2;
    ...
    main_closure_animate: function main_closure_animate(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._box_0 = t0;
      _._box_1 = t1;
      _.startTime = t2;
  ...
  A.main_drawHeart.prototype = {
    call$1(scale) {
      var t2, t3, t4, t5, gradient, t6, _this = this,
        t1 = _this.ctx;
      ...
      t4 = _this.size;
      t5 = t4 * 0.7;
      t1.arc(t2, t3 + t5, t5, 0, 6.283185307179586, false);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "rgba(255, 0, 0, 0.2)");
      t1.shadowBlur = 50;
      t1.shadowColor = "red";
      t1.fill();
      t1.restore();
      ...
      t3 = -t4;
      gradient = t1.createLinearGradient(0, t3, 0, t4);
      ...
      t5 = t3 * 1.1;
      t6 = t3 * 0.1;
      t1.bezierCurveTo(t4 * 0.5, t5, t4 * 1.6, t6, 0, t4);
      t1.bezierCurveTo(t3 * 1.6, t6, t2, t5, 0, t2);
      t1.closePath();
      t1.fill();
      t1.restore();
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      t4 = window;
      t4.toString;
      B.Window_methods.requestAnimationFrame$1(t4, new A.main_closure_animate(t1, t2, t3, 200, 0.8, this.drawHeart));
    },
    $signature: 11
  };
  A.main_closure_animate.prototype = {
    call$1(_) {
      var t, t1, t2, _this = this;
      A._asNum(_);
      t = (Date.now() - _this.startTime) / _this.duration;
      if (t < 0.5) {
        t1 = _this._box_0;
        t1.scale = 1 - (1 - _this.targetScale) * (t * 2);
      } else {
        t1 = _this._box_0;
        if (t < 1) {
          t2 = _this.targetScale;
          t1.scale = t2 + (1 - t2) * ((t - 0.5) * 2);
        } else {
          t1.scale = 1;
          _this._box_1.animating = false;
          _this.drawHeart.call$1(1);
          return;
        }
      }
      _this.drawHeart.call$1(t1.scale);
      t1 = window;
      t1.toString;
      B.Window_methods.requestAnimationFrame$1(t1, _this);
    },
    $signature: 12
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.CanvasRenderingContext2D, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.Event]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_drawHeart, A.main_closure, A.main_closure_animate]);
